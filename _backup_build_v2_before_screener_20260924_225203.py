...
def main():
    ...
    remaining = [p for p in ["__WB_DATA_JSON__", "__WB_DATES_JSON__", "__WB_DATES_INLINE_JSON__",
                             "__WB_INDUSTRY_JSON__", "__WB_BREAK_JSON__", "__WB_BUILD_STR__"] if p in out]
    if remaining:
    ...
    build_lite(tpl_text, wb_data, wb_dates, wb_dates_inline, wb_build, ind_json, brk_json)
...
def build_lite(tpl_text, wb_data, wb_dates, wb_dates_inline, wb_build, ind_json="{}", brk_json="[]"):
